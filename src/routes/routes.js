...
export const publicRoutes = [
  ...
  { id: 4, path: "/", component: <Navigate to="/login" replace={true} />, exact: true },
];
...
export const privateRoutes = [
  ...
  { id: 4, path: "/home/:todoId", component: <TodoHistory />, exact: true },
  { id: 5, path: "/history", component: <History />, exact: true },
  { id: 6, path: "/", component: <Navigate to="/home" replace={true} />, exact: true },
];
